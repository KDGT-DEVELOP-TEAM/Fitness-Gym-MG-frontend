...
// import { LessonForm } from './pages/LessonForm'; // 存在しない - LessonCreateを使用
import { LessonCreate } from './pages/common/LessonCreate';
// import { LessonHistory } from './pages/LessonHistory'; // 存在しない - 実装が必要
import { CustomerProfile } from './pages/CustomerProfile';
// import { PostureList } from './pages/PostureList'; // 存在しない - PostureImageListを使用
import { PostureImageList } from './pages/common/PostureImageList';
// import { PostureCompare } from './pages/PostureCompare'; // 存在しない - 実装が必要
